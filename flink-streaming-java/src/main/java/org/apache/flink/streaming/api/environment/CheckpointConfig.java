...
public class CheckpointConfig implements java.io.Serializable {
    ...
    private boolean restoreWithScalingByFileIngestion = false;
    ...
    public void setRestoreWithScalingByFileIngestion(boolean restoreWithScalingByFileIngestion) {
    ...
    public void configure(ReadableConfig configuration) {
        ...
        configuration
                .getOptional(CheckpointingOptions.RESTORE_WITH_RESCALING_BY_FILE_INGESTION)
                .ifPresent(this::setRestoreWithScalingByFileIngestion);
    }
}
