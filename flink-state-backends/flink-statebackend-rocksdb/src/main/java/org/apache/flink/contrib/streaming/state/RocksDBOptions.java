...
public class RocksDBOptions {
    ...
    public static final ConfigOption<String> ROCKSDB_COMPACTION_SCHEDULE_STRATEGY_TYPE =
            ConfigOptions.key("state.backend.rocksdb.compaction.type")
                    .noDefaultValue();

    public static final ConfigOption<Long> ROCKSDB_COMPACTION_SYNC_ROCKSDB_INTERVAL =
            ConfigOptions.key("state.backend.rocksdb.compaction.sync-rocksdb.interval")
                    .defaultValue(180_000L);

    public static final ConfigOption<Boolean> ENABLE_TRIVIAL_MOVE_AFTER_FILE_INGESTION =
            ConfigOptions.key("state.backend.rocksdb.compaction.trivial-move-after-file-ingestion")
                    .defaultValue(false);
