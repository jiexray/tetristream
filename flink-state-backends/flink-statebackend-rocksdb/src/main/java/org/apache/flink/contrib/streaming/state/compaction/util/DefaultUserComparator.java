...
public class DefaultUserComparator implements Comparator<InternalKey> {
    private static DefaultUserComparator instance;

    private DefaultUserComparator() {}

    public static DefaultUserComparator getInstance() {
        if (instance == null) {
            synchronized (DefaultUserComparator.class) {
                if (instance == null) {
                    instance = new DefaultUserComparator();
                }
            }
        }
        return instance;
