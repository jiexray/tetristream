...
public class RocksDBOperationUtils {
    ...
    public static RocksDBKeyedStateBackend.RocksDbKvStateInfo createStateInfo(
            ...
            Function<String, ColumnFamilyOptions> columnFamilyOptionsFactory,
            @Nullable RocksDbTtlCompactFiltersManager ttlCompactFiltersManager,
            @Nullable RocksDBRescalingCompactFiltersManager rescalingCompactFiltersManager) {
    ...
    public static ColumnFamilyDescriptor createColumnFamilyDescriptor(
        ...
        return createColumnFamilyDescriptor(
                metaInfoBase, columnFamilyOptionsFactory, ttlCompactFiltersManager, null);
    }
    ...
    public static ColumnFamilyDescriptor createColumnFamilyDescriptor(
        ...
        if (rescalingCompactFiltersManager != null) {
            rescalingCompactFiltersManager.setAndRegisterCompactFilterIfRescaling(
    ...
    public static OpaqueMemoryResource<RocksDBSharedResources> allocateSharedCachesIfConfigured(
            RocksDBMemoryConfiguration memoryConfig, MemoryManager memoryManager, Logger logger)
            throws IOException {
