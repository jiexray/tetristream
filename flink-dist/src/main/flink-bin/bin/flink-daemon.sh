...
metrics_log="/home/tian/project/flink-comp/metrics-log/${FLINK_IDENT_STRING}-${DAEMON}-${id}-${HOSTNAME}-metrics.log"


log_setting=("-Dlog.file=${log}" "-Dmetrics.log.file=${metrics_log}" "-Dlog4j.configuration=file:${FLINK_CONF_DIR}/log4j.properties" "-Dlog4j.configurationFile=file:${FLINK_CONF_DIR}/log4j.properties" "-Dlogback.configurationFile=file:${FLINK_CONF_DIR}/logback.xml")
