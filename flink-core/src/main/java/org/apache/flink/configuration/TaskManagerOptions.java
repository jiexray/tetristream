...
public class TaskManagerOptions {
    ...
    public static final ConfigOption<Double> ROCKSDB_COMPACTION_CPU_USAGE_RATIO =
            ConfigOptions.key("state.backend.rocksdb.compaction.cpu.ratio")
                    .defaultValue(0.1);

    public static final ConfigOption<Long> ROCKSDB_COMPACTION_IDLE_SCHEDULE_INTERVAL =
            ConfigOptions.key("state.backend.rocksdb.compaction.idle.interval")
                    .defaultValue(30000L);

    public static final ConfigOption<Long> ROCKSDB_COMPACTION_COLLECT_INTERVAL =
            ConfigOptions.key("state.backend.rocksdb.compaction.collect.interval")
                    .defaultValue(30_000L);

    public static final ConfigOption<Boolean> ROCKSDB_COMPACTION_PRINT_DEBUG_MSG =
            ConfigOptions.key("state.backend.rocksdb.compaction.print-debug-msg")
                    .defaultValue(false);
    // ------------------------------------------------------------------------
