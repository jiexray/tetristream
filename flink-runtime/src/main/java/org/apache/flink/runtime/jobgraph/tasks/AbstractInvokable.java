...
import org.apache.flink.runtime.state.rocksdb.CompactionSchedulerManager;
 ...
 * #triggerCheckpointOnBarrier(CheckpointMetaData, CheckpointOptions, CheckpointMetrics)}, {@link
 * #abortCheckpointOnBarrier(long, Throwable)} and {@link #notifyCheckpointCompleteAsync(long)}.
 */
public abstract class AbstractInvokable {
    ...
    private CompactionSchedulerManager compactionSchedulerManager;
    ...
    public void setCompactionSchedulerManager(
            CompactionSchedulerManager compactionSchedulerManager) {
        this.compactionSchedulerManager = compactionSchedulerManager;
    }

    protected void registerCompactionScheduler(
            TaskInfo taskInfo, @Nullable CompactionCollector compactionCollector) {
        this.compactionSchedulerManager.registerCompactionScheduler(taskInfo, compactionCollector);
    }

    protected void unregisterCompactionScheduler(TaskInfo taskInfo) {
        this.compactionSchedulerManager.unregisterCompactionScheduler(taskInfo);
    }
}
