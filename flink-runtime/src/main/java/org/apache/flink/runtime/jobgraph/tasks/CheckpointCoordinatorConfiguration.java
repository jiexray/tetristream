...
public class CheckpointCoordinatorConfiguration implements Serializable {
    ...
    private CheckpointCoordinatorConfiguration(
            ...
            int tolerableCpFailureNumber,
            boolean isUnalignedCheckpointsEnabled,
            boolean restoreWithScalingByFileIngestion) {
        ...
        this.restoreWithScalingByFileIngestion = restoreWithScalingByFileIngestion;
    ...
    public boolean isRestoreWithScalingByFileIngestion() {
        return restoreWithScalingByFileIngestion;
    }
    ...
    public boolean equals(Object o) {
        ...
        return checkpointInterval == that.checkpointInterval
                ...
                && restoreWithScalingByFileIngestion == that.restoreWithScalingByFileIngestion;
    }
    ...
    public int hashCode() {
        return Objects.hash(
                ...
                restoreWithScalingByFileIngestion);
    }
    ...
    public static class CheckpointCoordinatorConfigurationBuilder {
        ...
        private boolean restoreWithScalingByFileIngestion;
        ...
        public CheckpointCoordinatorConfigurationBuilder setRestoreWithScalingByFileIngestion(
                boolean restoreWithScalingByFileIngestion) {
            this.restoreWithScalingByFileIngestion = restoreWithScalingByFileIngestion;
            return this;
        }
