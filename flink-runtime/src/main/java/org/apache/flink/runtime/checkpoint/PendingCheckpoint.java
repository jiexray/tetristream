        ...
        synchronized (lock) {
            ...
            try {
                ...
                for (OperatorState operatorState : operatorStates.values()) {
                    totalStateSize += operatorState.getTotalStateSize();
                }
                ...
                if (statsCallback != null) {
                    ...
                    CompletedCheckpointStats.DiscardCallback discardCallback =
                            statsCallback.reportCompletedCheckpoint(
                                    finalizedLocation.getExternalPointer(), totalStateSize);
                    ...
                    executor.execute(
                            new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    // unregistered shared states are still considered private at
                                    // this point.
                                    try {
