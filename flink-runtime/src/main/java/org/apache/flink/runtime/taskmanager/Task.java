...
public class Task
    ...
    public Task(
        ...
        this.compactionSchedulerManager = Preconditions.checkNotNull(compactionSchedulerManager);
    ...
    private void doRun() {
        ...
        try {
            ...
            invokable.setCompactionSchedulerManager(compactionSchedulerManager);
