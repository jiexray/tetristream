...
public class CheckpointStatsTracker {
    ...
    @VisibleForTesting
    static final String LATEST_COMPLETED_CHECKPOINT_SIZE_METRIC = "lastCheckpointIncSize";

    static final String LATEST_COMPLETED_CHECKPOINT_TOTAL_STATE_SIZE_METRICS = "lastCheckpointSize";
    ...
    private void registerMetrics(MetricGroup metricGroup) {
        ...
        metricGroup.gauge(
                LATEST_COMPLETED_CHECKPOINT_TOTAL_STATE_SIZE_METRICS,
                new LatestCompletedCheckpointTotalSizeGauge());
        metricGroup.gauge(
