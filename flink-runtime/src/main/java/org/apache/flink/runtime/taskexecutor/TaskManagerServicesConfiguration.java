...
import org.apache.flink.runtime.state.rocksdb.CompactionSchedulerManagerConfig;
...
public class TaskManagerServicesConfiguration {
    ...
    private final CompactionSchedulerManagerConfig compactionSchedulerManagerConfig;
    ...
    private TaskManagerServicesConfiguration(
        ...
        this(
                ...
                tmpDirPaths,
                localRecoveryStateRootDirectories,
    ...
    private TaskManagerServicesConfiguration(
            ...
            String[] alwaysParentFirstLoaderPatterns,
            int numIoThreads,
            CompactionSchedulerManagerConfig compactionSchedulerManagerConfig) {
        ...
        this.compactionSchedulerManagerConfig = compactionSchedulerManagerConfig;
    }
    ...
    public CompactionSchedulerManagerConfig getCompactionSchedulerManagerConfig() {
        return compactionSchedulerManagerConfig;
    }
    ...
    public static TaskManagerServicesConfiguration fromConfiguration(
        ...
        final CompactionSchedulerManagerConfig compactionSchedulerManagerConfig =
                new CompactionSchedulerManagerConfig(
                        configuration.getDouble(
                                TaskManagerOptions.ROCKSDB_COMPACTION_CPU_USAGE_RATIO),
                        configuration.getLong(
                                TaskManagerOptions.ROCKSDB_COMPACTION_IDLE_SCHEDULE_INTERVAL),
                        configuration.getLong(
                                TaskManagerOptions.ROCKSDB_COMPACTION_COLLECT_INTERVAL),
                        configuration.getBoolean(
                                TaskManagerOptions.ROCKSDB_COMPACTION_PRINT_DEBUG_MSG));
        ...
        return new TaskManagerServicesConfiguration(
                ...
                alwaysParentFirstLoaderPatterns,
                numIoThreads,
                compactionSchedulerManagerConfig);
    }
}
